...
public class LoginPage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jToggleButton1.setSelectedIcon(new javax.swing.ImageIcon(getClass().getResource("/images/eye-close.png"))); // NOI18N
        ...
        jPanel1.add(jPanel2);
        jPanel2.setBounds(260, -10, 520, 480);
    ...
    private void jToggleButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton1ActionPerformed
        ...
        if (jToggleButton1.isSelected()) {
            ...
            jToggleButton1.setIcon(getIconSafe("/images/eye-open.png"));
        } else {
            jToggleButton1.setIcon(getIconSafe("/images/eye-close.png"));
            String password = new String(jPasswordField1.getPassword());
            if (!password.trim().equals("Enter password")) {
                jPasswordField1.setEchoChar(originalEchoChar);  // hide password
            }
        }
...
private void addPlaceholders() {
    originalEchoChar = '•'; // Force elegant modern bullet dot instead of old-fashioned asterisk
    
    addPlaceholder(jTextField1, "Enter email or ID");
    addPasswordPlaceholder(jPasswordField1, "Enter password");
    
    // Style toggle button to be completely transparent and non-focusable
    jToggleButton1.setFocusPainted(false);
    jToggleButton1.setContentAreaFilled(false);
    jToggleButton1.setFocusable(false);
    jToggleButton1.setSelectedIcon(null); // Disable automatic Swing selectedIcon to give us full manual control
}
...
private void addPasswordPlaceholder(javax.swing.JPasswordField field, String placeholder) {
    ...
    field.addFocusListener(new java.awt.event.FocusAdapter() {
        public void focusGained(java.awt.event.FocusEvent e) {
            ...
            if (password.trim().equals(placeholder.trim())) {
                field.setText("");
                if (!jToggleButton1.isSelected()) {
                    field.setEchoChar(originalEchoChar);
                }
                field.setForeground(new java.awt.Color(30, 30, 30));
            }
        }
...
private javax.swing.ImageIcon getIconSafe(String path) {
    try {
