...
public class DownloadResultFrame
extends JFrame {

    public DownloadResultFrame() {
        this.initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Student Management System - Download Result");
        setResizable(false);
        ...
        jButtonDownload.setText("Download PDF");
        jButtonDownload.setFont(new java.awt.Font("Segoe UI", 1, 13)); // NOI18N
        jButtonDownload.setBackground(new java.awt.Color(11, 27, 226));
        ...
        jButtonDownload.setBounds(30, 410, 130, 35);

        jButtonPrint.setText("Print Result");
        jButtonPrint.setFont(new java.awt.Font("Segoe UI", 1, 13)); // NOI18N
        jButtonPrint.setFocusPainted(false);
        jPanel3.add(jButtonPrint);
        jButtonPrint.setBounds(175, 410, 115, 35);

        jLabel2.setText("Download Scorecard");
        ...
        jTextAreaReport.setText("Select academic term to generate printable scorecard previews...");
        jTextAreaReport.setFont(new java.awt.Font("Consolas", 0, 12)); // NOI18N
        jScrollPaneReport.setViewportView(jTextAreaReport);

        jPanel3.add(jScrollPaneReport);
        jScrollPaneReport.setBounds(30, 130, 480, 250);
