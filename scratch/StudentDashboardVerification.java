...
public class StudentDashboardVerification {

    public static void main(String[] args) {
        System.out.println("==================================================");
        System.out.println("  STUDENT DASHBOARD WORKFLOW & MVC VERIFICATION");
        System.out.println("==================================================");

        boolean passAll = true;

        // 1. Verify MVC compliance of StudentDashboard.java
    ...
    private static boolean verifyViewMvcCompliance() {
        System.out.println("Test 1: MVC Compliance Check on StudentDashboard.java");
        try {
            Class<?> clazz = Class.forName("view.StudentDashboard");
            
            // Check fields
            Field[] fields = clazz.getDeclaredFields();
            System.out.println("  Checking fields in StudentDashboard.java:");
            for (Field f : fields) {
            ...
            System.out.println("  Checking methods in StudentDashboard.java:");
            ...
            System.out.println("  Checking inner classes in StudentDashboard.java:");
            ...
            System.out.println("  [PASS] StudentDashboard.java has 0 listeners and is passive (VectorIcon allowed temporarily).");
            return true;
        } catch (Exception e) {
    ...
    private static boolean verifyUiBehavior() {
        ...
        try {
            ...
            StudentDashboardController controller = new StudentDashboardController(view);
            ...
            if (!new Color(224, 242, 248).equals(profileBtn.getBackground()) ||
                !new Color(11, 27, 226).equals(profileBtn.getForeground())) {
                System.out.println("FAIL (Profile inactive background/foreground mismatched)");
                return false;
            }
            System.out.println("PASS");
            ...
            if (!new Color(233, 212, 209).equals(profileBtn.getBackground())) {
                System.out.println("FAIL (Active button hover color mismatch: " + profileBtn.getBackground() + ")");
                return false;
            }

            MouseEvent exitProfile = new MouseEvent(profileBtn, MouseEvent.MOUSE_EXITED, System.currentTimeMillis(), 0, 0, 0, 0, false);
            for (MouseListener ml : profileBtn.getMouseListeners()) {
                ml.mouseExited(exitProfile);
            }
            if (!new Color(243, 227, 225).equals(profileBtn.getBackground())) {
